 ...
 */
val modName = "Scraphic Ships Bad Hulls and Weapons"
...
val modFolderName = "ScraphicShips"
//
//
// ==============
...
val jarFileName = "${modFolderName.replace(" ", "-")}.jar"
val modId = "aury_ScraphicLesbadHulls"
val modAuthor = "Aury"
val modDescription = "Terrible ideas given form and life."
val gameVersion = "0.95.1a-RC6"
val jars = arrayOf("jars/$jarFileName")
val modPlugin = "com.aurum.data.scripts.ScraphicHullsModPlug"
val isUtilityMod = false
val masterVersionFile = "https://raw.githubusercontent.com/Aurysystem/scraphic-hulls-bad-ideas/master/$modId.version"
    ...
    register<Copy>("install-mod") {
        ...
        destinations.forEach { dest ->
            copy {
                from(projectDir)
                into(dest)
                exclude(".git", ".github", ".gradle", ".idea", ".run", "gradle", "libs", "build")
            }
        }
    }
}
